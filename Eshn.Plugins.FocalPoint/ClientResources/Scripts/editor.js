define(['dojo/on', 'dojo/_base/declare', 'dojo/aspect', 'dijit/registry', 'dijit/WidgetSet', 'dijit/_Widget', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'epi/epi', 'epi/shell/widget/_ValueRequiredMixin', 'epi-cms/_ContentContextMixin', 'epi/i18n!epi/cms/nls/focalpoint', 'xstyle/css!./widget-template.css'], function (on, declare, aspect, registry, WidgetSet, _Widget, _TemplatedMixin, _WidgetsInTemplateMixin, epi, _ValueRequiredMixin, _ContentContextMixin, resources) {
  return declare([_Widget, _TemplatedMixin, _WidgetsInTemplateMixin, _ValueRequiredMixin, _ContentContextMixin], {
    templateString: dojo.cache('focal-point', 'widget-template.html'),
    imageUrl: null,
    ...
    hasCoordinates: function () {
      ...
      return this.value.x !== undefined && this.value.y !== undefined && !isNaN(this.value.x) && !isNaN(this.value.y) && this.value.x !== 0 && this.value.y !== 0;
    },
    ...
    isValid: function () {
      ...
      var isValidCoordinatesObject = this.value.x !== undefined && this.value.y !== undefined && !isNaN(this.value.x) && !isNaN(this.value.y) && this.value.x !== 0 && this.value.y !== 0;
